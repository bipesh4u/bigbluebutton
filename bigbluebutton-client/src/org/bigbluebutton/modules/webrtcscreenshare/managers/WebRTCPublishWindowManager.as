...
import org.bigbluebutton.modules.webrtcscreenshare.managers.*;
	...
	public class WebRTCPublishWindowManager {
		private static const LOGGER:ILogger = getClassLogger(WebRTCPublishWindowManager);
		...
		public function WebRTCPublishWindowManager(service:WebRTCScreenshareService) {
