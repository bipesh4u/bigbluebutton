...
import org.bigbluebutton.modules.webrtcscreenshare.managers.*;
	...
	import org.bigbluebutton.modules.webrtcscreenshare.view.components.WebRTCDesktopViewWindow;

	public class WebRTCViewerWindowManager {
		private static const LOGGER:ILogger = getClassLogger(WebRTCViewerWindowManager);
		...
		public function WebRTCViewerWindowManager(service:WebRTCScreenshareService) {
